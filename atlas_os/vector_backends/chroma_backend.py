...
It is an *optional* backend: install it with ``pip install 'atlas-os[chroma]'``.
...
``0.0–1.0`` similarity score the rest of Atlas OS expects.
"""
...
from atlas_os.vector_backend import CHROMA, VectorBackend
...
def _require_chromadb() -> Any:
    ...
    try:
        ...
        raise RuntimeError(
            ...
            "install it with: pip install 'atlas-os[chroma]'"
        ) from exc
    return chromadb
