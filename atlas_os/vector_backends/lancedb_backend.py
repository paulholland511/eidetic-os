...
It is an *optional* backend: install it with ``pip install 'atlas-os[lancedb]'``.
...
from atlas_os.vector_backend import LANCEDB, VectorBackend
...
def _require_lancedb() -> Any:
    ...
    try:
        ...
        raise RuntimeError(
            ...
            "install it with: pip install 'atlas-os[lancedb]'"
        ) from exc
    return lancedb
