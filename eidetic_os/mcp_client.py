...
The Eidetic OS runtime uses this to launch and talk to MCP servers — both the
...
* **Synchronous.** Eidetic OS is a one-shot CLI; a blocking request/response client
...
from eidetic_os.mcp_server import PROTOCOL_VERSION
...
class MCPClient:
    ...
    def __init__(self, transport: Transport, *, client_name: str = "eidetic-os", client_version: str = "0.0.0") -> None:
