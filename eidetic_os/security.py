...
Before Eidetic OS installs a skill it can't fully trust — anything pulled from a
...
``BLOCK``
    ...
    contains one of these, and ``eidetic skills install`` will not proceed.
``WARN``
...
The companion :mod:`eidetic_os.sandbox` covers the *runtime* side — executing a
